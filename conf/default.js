...
module.exports = {
	...
	// API key
	apikey: process.env.APIB_APIKEY,
	...
	session: {
		...
		encryptionKey: 'LR+yQyV/ebGhgRaGjIZhnVUl9wUV3OwnTJWXMcSZZXs=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'xdQrVca+D69bfzOtG/GgvZ9K/QVPdA7WgzZnwQLJ0SzvBbPXyvZUWmsPsjW5sU8sFnzfcffITCJuJuBvxJWXQQ==',
		// should be a large unguessable string
		secret: '0uNMhH4JVNIiGvg+YIAI//JrCLE0bcgN',
	...
	cookieSecret: '37pp+KpcHcbzn2Y6dwgrONmQWLWsCLDb',
